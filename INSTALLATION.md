...
|-----------|--------|-----------------|
| Agent/Workflow wrappers | `EM-Team/.claude/skills/em:*.md` | `~/.claude/skills/em:*/SKILL.md` (symlinks) |
| Skill wrappers (89) | `EM-Team/.claude/skills/em:skill-*.md` | `~/.claude/skills/em:skill:*/SKILL.md` (symlinks) |
| Agents (38) | `EM-Team/agents/*.md` | Referenced via `~/.claude/config.json` |
| Workflows (27) | `EM-Team/workflows/*.md` | Referenced via `~/.claude/config.json` |
