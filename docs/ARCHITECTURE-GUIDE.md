...
EM-Team là một **thư viện skills/agents/workflows** chạy trên **Claude Code** (CLI tool của Anthropic). Khi bạn install EM-Team, bạn đang thêm 76+ commands chuyên biệt vào Claude Code — biến Claude thành một engineering team ảo.
...
│   └── skills/             ← WRAPPER FILES (43 agent wrappers + 43 skill wrappers)
...
│   ├── development/        16 skills phát triển
...
│
├── agents/                 ← AGENT FILES (28 agents, mỗi cái là 1 AI specialist)
...
- Có 43 skills, 28 agents, 23 workflows sẵn sàng
...
type: agent
version: 1.2.0
trigger: duck:planner             # trigger keyword
description: "..."
...
- **v2.2.0** (2026-05-01) — 7 new skills + NestJS patterns + related_skills + install mechanism cải thiện
- **v2.1.0** (2026-05-01) — Communication styles system + v2.0.0 architecture upgrade
- **v2.0.0** — 6 source repos integration, 28 agents, 23 workflows
