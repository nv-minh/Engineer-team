# Hướng Dẫn Sử Dụng EM-Team v2.2.0
...
EM-Team v2.2.0 cung cấp 97+ commands được tổ chức thành 3 danh mục chính:
...
EM-Team v2.2.0 có hệ thống điều khiển giao tiếp thống nhất với 2 trục độc lập:
...
EM-Team v2.2.0 sử dụng cấu trúc command thống nhất:
