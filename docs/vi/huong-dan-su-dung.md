# Hướng Dẫn Sử Dụng EM-Team v2.1.0
...
EM-Team v2.1.0 cung cấp 90+ commands được tổ chức thành 3 danh mục chính:

| Phương pháp | Số lượng | Mô tả | Tốt nhất cho |
|-------------|----------|-------|--------------|
| **Skills** | 36 | Patterns và practices có thể tái sử dụng | Tasks phát triển cụ thể |
